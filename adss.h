...
// Server Port IOCTLs
//
#define IOCTL_ADSS_IPC_SERVER_WAIT_FOR_CONNECTION           CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0C, METHOD_NEITHER, FILE_ANY_ACCESS) //0x220033
...
#define IOCTL_ADSS_IPC_CONNECTION_UNMARSHAL_VFS_FILE        CTL_CODE(FILE_DEVICE_UNKNOWN, 0x2E, METHOD_NEITHER, FILE_ANY_ACCESS) //0x2200BB
...
#define IOCTL_ADSS_LX_PROCESS_HANDLE_WAIT_FOR_SIGNAL        CTL_CODE(FILE_DEVICE_UNKNOWN, 0x34, METHOD_NEITHER, FILE_ANY_ACCESS)  //0x2200D3
